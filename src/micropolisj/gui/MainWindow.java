	...
	implements Micropolis.Listener, EarthquakeListener
{
	...
	public MainWindow(Micropolis engine)
	{
		...
		overlaysMenu.add(makeMapStateMenuItem("menu.overlays.CAPTAIN_OVERLAY", MapState.CAPTAIN_OVERLAY));
	...
	private JToolBar makeToolbar()
	{
		...
		//Add the CAPTAIN icon to the tool bar
		c.gridy++;
		Box b7 = new Box(BoxLayout.X_AXIS);
		gridBox.add(b7,c);
		b7.add(makeToolBtn(MicropolisTool.CAPTAIN));
